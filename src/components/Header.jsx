const Header = () => {
  return (
    <ul className="header flex text-stone-500 flex-col justify-between item-center bg-[#d7ff55] h-full w-[8rem] px-4 fixed left-0 top-0 py-2 gap-8 z-10">
      <div className="font-bold bg-[#414141] px-1 py-2 rounded-md flex flex-col items-center justify-center cursor-pointer gap-2">
        ...
        <button className="gap-2xt-[1rem] bg-[#d7ff55] px-1 py-1 rounded-sm text-[#414141] border-[1px] border-[#d7ff55] hover:text-[#d7ff55] hover:bg-[#414141]">
          Download
        </button>
      </div>
      <div className="flex flex-col h-auto gap-[10rem] max-md:gap-0 max-sm:gap-[10rem] sm:gap-[10rem]">
        <figure className="w-[20rem] px-2 py-2 text-[#414141] h-auto transform translate-x-[-7rem] translate-y-0 -rotate-90 rounded-md flex flex-col justify-around items-start">
          ...
          <div className="text-[#414141] text-2xl w-full flex justify-between items-center">
            ...
            <button className="download-nav-btn flex gap-2 items-center bg-[#414141] text-[#d7ff55] text-xl px-1 py-1 rounded-md font-extrabold border-2 border-[#414141] hover:bg-transparent hover:text-[#414141]">
