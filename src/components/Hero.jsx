  ...
  return (
    <section className="hero-section flex justify-end items-end">
      <figure className="h-full flex flex-col justify-between items-end text-red-500 py-[5rem]">
        <div className="px-[2rem] py-[1rem] bg-[#414141] text-[18px] font-bold text-[#d7ff55] rounded-l-full border-2 border-[#d7ff55] hover:text-[#414141] hover:bg-[#d7ff55] cursor-pointer">
          <button>
            <h2>DOWNLOAD <i className="fa-solid fa-download"></i></h2>
          </button>
        </div>
        <div className="flex gap-2 px-[0.5rem] py-[0.5rem] text-[#414141] text-xl font-bold bg-[#d7ff55] rounded-md border-2 border-[#d7ff55] cursor-pointer">
